...
AscFonts.FT_Done_Library = function() {
	return Module["_ASC_FT_Done_FreeType"].apply(this, arguments);
}; 
AscFonts.FT_Set_TrueType_HintProp = function() {
	return Module["_ASC_FT_Set_TrueType_HintProp"].apply(this, arguments);
}; 
AscFonts.FT_Open_Face = function() {
	return Module["_ASC_FT_Open_Face"].apply(this, arguments);
}; 
AscFonts.FT_Done_Face = function() {
	return Module["_ASC_FT_Done_Face"].apply(this, arguments);
}; 
AscFonts.FT_SetCMapForCharCode = function() {
	return Module["_ASC_FT_SetCMapForCharCode"].apply(this, arguments);
}; 
AscFonts.FT_GetKerningX = function() {
	return Module["_ASC_FT_GetKerningX"].apply(this, arguments);
}; 
AscFonts.FT_GetFaceMaxAdvanceX = function() {
	return Module["_ASC_FT_GetFaceMaxAdvanceX"].apply(this, arguments);
}; 
AscFonts.FT_Set_Transform = function() {
	return Module["_ASC_FT_Set_Transform"].apply(this, arguments);
}; 
AscFonts.FT_Set_Char_Size = function() {
	return Module["_ASC_FT_Set_Char_Size"].apply(this, arguments);
}; 
...
AscFonts.FT_Load_Glyph = function() {
	return Module["_ASC_FT_Load_Glyph"].apply(this, arguments);
}; 
AscFonts.FT_SetCMapForCharCode = function() {
	return Module["_ASC_FT_SetCMapForCharCode"].apply(this, arguments);
}; 
...
AscFonts.HB_FontFree = function() {
	return Module["ASC_HB_FontFree"].apply(this, arguments);
}; 
